...
keyboard.add_hotkey('3', lambda: server.assign_card_id(list(server.workers.keys())[0], "643"))
keyboard.add_hotkey('e', lambda: server.assign_card_id(list(server.workers.keys())[1], "643"))
keyboard.add_hotkey('4', lambda: server.disassign_card_id(list(server.workers.keys())[0]))
